/**
 * JavaScript code for all WTG Portal Manager admin screens, it makes postboxes work
 *
 * @package WTG Portal Manager
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of WTGPORTALMANAGER plugin)
 * @since 0.0.1
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For WTGPORTALMANAGER, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 0.0.1
	 */
