...
class WTGPORTALMANAGER_UI extends WTGPORTALMANAGER {     
    ...
    */
    public function status_box( $title, $intro, $progress_array = array() ){
        ...
        // outputs a white box containing header, text then a darker box for key information.
        // intended for use on a standard WP admin view which is not normaly white.
        echo ' 
        <div class="wtgportalmanager_status_box_container">
            <div class="welcome-panel">
                ...
                <div class="welcome-panel-content">
                    ...
                    <p>'.__( 'Changes you make right now will only be applied to the current active portal.' ).'</p>                                                     
                </div>
