...
* @version 1.0
*/
class WTGPORTALMANAGER_Formbuilder extends WTGPORTALMANAGER_UI {
    ...
    */
    public function deregister_form( $form_id ) {
        ...
        update_option( 'wtgportalmanager_formvalidation', array() );
    }
    ...
    public function apply_input_security() {
        ...
        if( isset( $this->form_val_arr[ $user_ID ][ $form_id ] ) ) {
            ...
            foreach( $this->form_val_arr[ $user_ID ][ $form_id ] as $input_name => $input_array ) {
                ...
                // dont do this if the user has selected the default - usually "notselected123"
                if( $input_array['inputtype'] == 'menu' && $_POST[ $input_name ] !== 'notselected123' ) {
    ...
    */
    public function form_start( $form_id, $form_name, $form_title, $uploader = false ){
        ...
        echo '<input type="hidden" name="wtgportalmanager_hidden_pagename" value="' . $wtgportalmanager_page_name . '">';
    ...
    public function input_checkboxes(){
        ...
        <tr valign="top">
            ...
            foreach( $this->itemsarray as $item_value => $item_title ) {
                ...
                // set check/on condition using $this->currentvalue (pass array due to possibility of multiple values rather than a string)
