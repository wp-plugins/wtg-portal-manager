    ...
    public function newflag() {
        ...
        /*  add arguments for these meta
            ...
            add_meta_box(
                'flags-meta-phpline',            
                esc_html__( 'PHP Line' ),       
                'wtgportalmanager_meta_box_flags_phpline',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            );
            ...
            add_meta_box(
                ...
                'wtgportalmanager_meta_box_flags_phpfunction',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            );       
            ...
            add_meta_box(
                'flags-meta-priority',            
                esc_html__( 'Priority' ),       
                'wtgportalmanager_meta_box_flags_priority',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-type',            
                esc_html__( 'Type' ),       
                'wtgportalmanager_meta_box_flags_type',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            );    
            ...
            add_meta_box(
                'flags-meta-fileurl',            
                esc_html__( 'File URL' ),       
                'wtgportalmanager_meta_box_flags_fileurl',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-dataid',            
                esc_html__( 'Data ID' ),       
                'wtgportalmanager_meta_box_flags_dataid',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-userid',            
                esc_html__( 'User ID' ),       
                'wtgportalmanager_meta_box_flags_userid',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                ...
                'wtgportalmanager_meta_box_flags_errortext',        
                'webtechglobalflags',                  
                'normal',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                ...
                'wtgportalmanager_meta_box_flags_projectid',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-reason',            
                esc_html__( 'Reason' ),       
                'wtgportalmanager_meta_box_flags_reason',        
                'webtechglobalflags',                  
                'normal',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-action',            
                esc_html__( 'Action' ),       
                'wtgportalmanager_meta_box_flags_action',        
                'webtechglobalflags',                  
                'normal',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                ...
                'wtgportalmanager_meta_box_flags_instructions',        
                'webtechglobalflags',                  
                'normal',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-creator',            
                esc_html__( 'Creator' ),       
                'wtgportalmanager_meta_box_flags_creator',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
            ...
            add_meta_box(
                'flags-meta-version',            
                esc_html__( 'Version' ),       
                'wtgportalmanager_meta_box_flags_version',        
                'webtechglobalflags',                  
                'side',                 
                'default'                  
            ); 
...
}// end class WTGPORTALMANAGER_Flags
?>