...
class WTGPORTALMANAGER_Install {
    ...
    */
    public function __construct() {
        ...
        register_activation_hook( WTGPORTALMANAGER_ABSPATH . 'wtgportalmanager.php', array( $this, 'install_plugin' ) ); 

        // on deactivation run disabled_plugin() - not a full uninstall
        register_deactivation_hook( WTGPORTALMANAGER_ABSPATH . 'wtgportalmanager.php',  array( $this, 'deactivate_plugin' ) );
        ...
        add_action( 'switch_blog', array( $this, 'register_webtechglobal_portalmeta_table' ) );
        $this->register_webtechglobal_portalmeta_table(); // register tables manually as the hook may have been missed             
    ...
    function register_webtechglobal_portalmeta_table() {
        global $wpdb;
        $wpdb->webtechglobal_portalmeta = "{$wpdb->prefix}webtechglobal_portalmeta";
    }    
    ...
    */
    function create_tables() {       
        global $charset_collate, $wpdb, $WTGPORTALMANAGER;
    ...
    */
    ...
    function install_options() {
        ...
        update_option( 'wtgportalmanager_installedversion', WTGPORTALMANAGER::version );# will only be updated when user prompted to upgrade rather than activation
