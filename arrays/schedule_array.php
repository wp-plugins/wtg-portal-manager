...
// history
$c2p_schedule_array['history']['lastreturnreason'] = __( 'None', 'wtgportalmanager' );
$c2p_schedule_array['history']['lasteventtime'] = time();
$c2p_schedule_array['history']['lasteventtype'] = __( 'None', 'wtgportalmanager' );
...
$c2p_schedule_array['history']['lasteventaction'] = __( 'None', 'wtgportalmanager' );
// times/days
...
$c2p_schedule_array['eventtypes']['deleteuserswaiting']['name'] = __( 'Delete Users Waiting', 'wtgportalmanager' ); 
...
$c2p_schedule_array['eventtypes']['sendemails']['name'] = __( 'Send Emails', 'wtgportalmanager' ); 
